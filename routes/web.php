...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('contracts')->name('contracts.')->group(function () {
        ...
        Route::post('/{id}/suspend', [ContractController::class, 'suspend'])->name('suspend');
        ...
        Route::post('/{id}/terminate-early', [ContractController::class, 'terminateEarly'])->name('terminate-early');
    });
