...
<head>
    ...
    <style>
        ...
        .card-header { background:#05436b;color:#fff;padding:16px;font-size:18px;font-weight:bold; }
        .card-body { padding:24px; }
        .table { width:100%;border-collapse:collapse;margin:20px 0; }
        .table td { padding:8px;border-top:1px solid #dee2e6; }
        .badge { display:inline-block;padding:0.35em 0.65em;font-size:0.85em;font-weight:600;
                 border-radius:0.25rem;color:#fff; }
        .badge.en_attente { background:#6c757d; }
        .badge.en_cours { background:#05426bcd; }
        .badge.traitee { background:#198754; }
        .badge.annulee { background:#212529; }
    </style>
</head>
<body>
