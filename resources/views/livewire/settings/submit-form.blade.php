<div class="space-y-3">
    ...
    @if ($type === 'texte')
        <div class="mb-2">
            ...
            <textarea rows="4" class="form-control @error('text_value') is-invalid @enderror" placeholder="Saisir la valeur…"
                wire:model.defer="text_value"></textarea>
            @error('text_value')
    ...
    @elseif($type === 'file')
        ...
        @if ($isEditing && !empty($existingDocs))
            <div class="mb-2">
    ...
    @elseif($type === 'liste')
        <div class="mb-2">
            <label class="form-label fw-semibold">Choix (multiples)</label>

            <select multiple size="6"
                class="form-select @error('list_values') is-invalid @enderror @error('list_values.*') is-invalid @enderror"
                wire:model.defer="list_values">
            ...
            <div class="form-text">Maintenir Ctrl pour sélectionner plusieurs éléments.</div>
            ...
            <div class="d-flex flex-wrap gap-3">
                @foreach ($options as $opt)
                    ...
                    <div class="form-check">
                        <input type="radio" id="cb-{{ $opt->id }}" class="form-check-input"
                            value="{{ $val }}" wire:model="checkbox_value">
    ...
    <div class="d-flex justify-content-end gap-2 pt-2">
        <button class="btn btn-primary" wire:click="save('{{ $isEditing ? 'update' : 'create' }}')"
