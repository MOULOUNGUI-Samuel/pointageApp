                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <button class="btn btn-sm btn-outline-primary"
                                                ...
                                                wire:target="openForm('{{ $d->id }}')">
                                                <span wire:loading.remove wire:target="openForm('{{ $d->id }}')">
                                                    <i class="fas fa-edit"></i>
                                                </span>
                                                <span wire:loading wire:target="openForm('{{ $d->id }}')">
                                            ...
                                            <button class="btn btn-sm btn-outline-danger"
                                                ...
                                                wire:loading.attr="disabled"
                                                wire:target="confirmDelete('{{ $d->id }}')">
                                                <span wire:loading.remove
                                                    wire:target="confirmDelete('{{ $d->id }}')">
                                                    <i class="fas fa-trash"></i>
                                                </span>
                                                <span wire:loading wire:target="confirmDelete('{{ $d->id }}')">
                                                    <i class="fas fa-spinner fa-spin"></i>
                                                </span>
                                            </button>
                    ...
                    <div class="col-lg-5">
                        ...
                        <form wire:submit.prevent="save">
                            <div class="mb-2">
                                ...
                                <input type="text"
                                    class="form-control @error('nom_domaine') is-invalid @enderror shadow"
