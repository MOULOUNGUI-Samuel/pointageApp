<div class="row g-4 mt-3">
    ...
    <div class="col-lg-6 border-end">
        ...
        <div class="d-flex align-items-center gap-2 mb-2">
            <span id="absCount-{{ $forUserId }}" class="badge bg-primary" style="display:none;">0 résultat</span>
            <small id="absCountHint-{{ $forUserId }}" class="text-primary"></small>
        </div>

        <div class="list-group">
            <div class="accordion" id="absenceAcc-{{ $forUserId }}">
                @forelse ($items as $a)
                    @php
                    ...
                    @endphp
                    @php
                        $searchBlob = trim(implode(' ', [$a->type, $a->reason, $a->justification, $a->return_notes]));
                    @endphp

                    <div class="accordion-item shadow-sm rounded-3 mb-2" wire:key="absence-{{ $a->id }}"
                        data-status="{{ $a->status }}" data-start="{{ $a->start_datetime?->format('Y-m-d\TH:i') }}"
                        ...
                        <h2 class="accordion-header" id="heading-{{ $a->id }}">
                            <button type="button" class="accordion-button {{ $isOpen ? '' : 'collapsed' }}"
                            ...
                            <div class="accordion-body">
                                ...
                                <div class="row g-3 mb-3">
                                    <div class="col-md-6">
                                        <div class="card h-100 border-0 shadow-sm">
                                            <div class="card-body">
                                                ...
                                                <div class="mb-1"><i
                                                        class="fas fa-calendar-day me-2"></i><strong>Début :</strong>
                                                    {{ $a->start_datetime?->format('d/m/Y H:i') }}</div>
                                                <div class="mb-1"><i
                                                        class="fas fa-calendar-check me-2"></i><strong>Fin :</strong>
                                                ...
                                                @if ($isApproved)
                                                    <div class="mt-2 small text-success"><i
                                                            class="fas fa-check-circle me-1"></i>Approuvée le
                                    ...
                                    <div class="col-md-6">
                                        <div class="card h-100 border-0 shadow-sm">
                                            <div class="card-body">
                                                <div class="fw-semibold text-muted mb-2">Pièces & décisions</div>

                                                {{-- Motif (complet) --}}
                                                <div class="mb-2">
                                                    <div class="text-muted small mb-1">Motif</div>
                                                    <div class="bg-light rounded p-2">{{ $a->reason ?: '—' }}</div>
                                                </div>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    @if ($a->attachment_path)
                                                        <a class="btn btn-sm btn-outline-secondary" target="_blank"
                                                            ...
                                                            <i class="fas fa-paperclip me-2"></i>Voir la pièce jointe
                                                        </a>
                                                    @else
                                ...
                                <div class="d-flex flex-wrap gap-2 mb-3" wire:key="actions-{{ $a->id }}">
                                ...
                                @if (data_get($confirmDelete, $a->id, false))
                                    <div
                                        ...
                                        <div><strong>Confirmer la suppression</strong> — Cette action est irréversible.
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex gap-2 mt-3">
                                                ...
                                                <button type="button" class="btn btn-danger"
                                                    wire:click="confirmReject('{{ $a->id }}')">Confirmer le
                                                    rejet</button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card mt-3 border-dark">
                                        <div class="card-body">
                                            ...
                                            @if ($isLate)
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label">Pièce jointe (facultative)</label>
                                                    <input type="file"
                                                    ...
                                                    <div wire:loading wire:target="returnAttachment"
                                                        class="small text-danger mt-1">Téléversement du document en
                                                        cours…</div>
                                                </div>
                                            @else
            ...
            <div id="absNoResult-{{ $forUserId }}" class="alert alert-info mt-3" style="display:none;">
    ...
    <div class="col-lg-6">
        ...
        <form wire:submit.prevent="save">
            ...
            <div class="mt-3">
                ...
                <input type="file" class="form-control @error('attachment') is-invalid @enderror shadow"
            ...
            <div class="d-flex gap-2 mt-4">
                ...
                <button type="button" class="btn btn-secondary" wire:click="openForm()">Réinitialiser</button>
            </div>
        </form>
    </div>
    <script>
        (() => {
            ...
            const scopeId = 'absenceAcc-{{ $forUserId }}';
            const $scope = document.getElementById(scopeId);
            const $noResult = document.getElementById('absNoResult-{{ $forUserId }}');
            const $count = document.getElementById('absCount-{{ $forUserId }}');
            const $countHint = document.getElementById('absCountHint-{{ $forUserId }}');
