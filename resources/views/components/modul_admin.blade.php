            ...
            <div class="row">
                            ...
                            <div class="modal fade" id="floatingLabelsModal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('ajout_module') }}" method="POST"
                ...
                @foreach ($modules as $module)
                    ...
                    <div class="col-lg-3 col-sm-12" style="margin-top: 20px;">
                        <div class="card-body shadow-lg px-2" style="background-color: white; border-radius: 10px;text-align: center;">
                            ...
                            @endif
                            <h3 class="text-success fw-bold">{{ $module->nom_module ?? 'YODIRH' }}</h3>
                                                        ...
                                                        <div class="col-md-7">
                                                            <div class="upload-container text-center">
                                                                <label for="file-upload-{{ $module->id }}" class="upload-box">
                                                                    ...
                                                                    <input id="file-upload-{{ $module->id }}" type="file" name="logo"
                                                                        accept="image/*" hidden>
                                                                </label>
                                                            </div>
                                                        </div>
