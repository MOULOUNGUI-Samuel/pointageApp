    ...
    <div class="d-flex" style="height: 100vh; overflow: hidden;">
      ...
      <aside class="bg-light text-dark px-4 shadow-sm d-flex flex-column"
        ...
        <div class="my-2 d-flex justify-content-between align-items-center bg-light">
          ...
          <img src="{{ asset('src/images/Logo_Nedco.png') }}" alt="Logo Nedco" style="width: 60px; height: 50px;">
        </div>
          ...
          <div id="nedcoreCarousel" class="carousel slide shadow rounded mb-4" data-bs-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img
                  src="https://img.freepik.com/photos-premium/groupe-diversifie-professionnels-costumes-affaires-debout-ensemble_412311-21321.jpg"
                  class="d-block w-100" alt="Module RH" style="height: 500px; object-fit: cover; border-radius: 10px;">
                <div class="carousel-caption d-none d-md-block bg-dark bg-opacity-50 rounded p-2">
                  <h5>Ressources Humaines</h5>
                  <p>Gérez vos effectifs, absences, contrats et évaluations avec clarté.</p>
                </div>
              </div>
              <div class="carousel-item">
                <img
                  src="https://img.freepik.com/photos-premium/equipe-commerciale-jeunes-africains-costumes_219728-237.jpg?uid=R89361838&ga=GA1.1.1094856274.1737491130&semt=ais_hybrid&w=740"
                  class="d-block w-100" alt="Finance" style="height: 500px; object-fit: cover; border-radius: 10px;">
                <div class="carousel-caption d-none d-md-block bg-dark bg-opacity-50 rounded p-2">
                  <h5>Finances</h5>
              ...
              <div class="carousel-item">
                <img
                  src="https://img.freepik.com/photos-gratuite/portrait-corporatif-equipe-trois-personnes_1262-20069.jpg?uid=R89361838&ga=GA1.1.1094856274.1737491130&semt=ais_hybrid&w=740"
                  class="d-block w-100" alt="Projet" style="height: 500px; object-fit: cover; border-radius: 10px;">
                <div class="carousel-caption d-none d-md-block bg-dark bg-opacity-50 rounded p-2">
            ...
            <button class="carousel-control-prev" type="button" data-bs-target="#nedcoreCarousel" data-bs-slide="prev">
              <span class="carousel-control-prev-icon bg-dark rounded-circle" aria-hidden="true"></span>
              <span class="visually-hidden">Précédent</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#nedcoreCarousel" data-bs-slide="next">
